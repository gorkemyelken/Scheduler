...
namespace Scheduler.SRT
{
    class Scheduler_SRT : Scheduler<Task>
    {
        ...
        public Scheduler_SRT(DataGridView datagrid_task_list, DataGridView datagrid_ready_queue, FlowLayoutPanel flow, RichTextBox textbox_output) : base(datagrid_task_list, flow, textbox_output)
        {
