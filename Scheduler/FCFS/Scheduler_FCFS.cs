...
namespace Scheduler.FCFS
{
    class Scheduler_FCFS : Scheduler<Task>
    {
        ...
        public Scheduler_FCFS(DataGridView datagrid_task_list, DataGridView datagrid_ready_queue, FlowLayoutPanel flow, RichTextBox textbox_output) : base(datagrid_task_list, flow, textbox_output)
        {
        ...
        void Reschedule()
        {
            ...
            next_task = ready_queue.OrderBy(t => t.Arrival_time).ElementAt(0);
